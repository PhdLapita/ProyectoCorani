package com.bearcreekmining.proyectocorani.Servicios;
...
public class BleService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =
            "com.qhipa.poloelectrico.Bluetooth.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "com.qhipa.poloelectrico.Bluetooth.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "com.qhipa.poloelectrico.Bluetooth.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =
            "com.qhipa.poloelectrico.Bluetooth.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA =
            "com.qhipa.poloelectrico.Bluetooth.EXTRA_DATA";
    public final static String DEVICE_DOES_NOT_SUPPORT_UART =
            "com.qhipa.poloelectrico.Bluetooth.DEVICE_DOES_NOT_SUPPORT_UART";

    public static final UUID TX_POWER_UUID = UUID.fromString("00001804-0000-1000-8000-00805f9b34fb");
    public static final UUID TX_POWER_LEVEL_UUID = UUID.fromString("00002a07-0000-1000-8000-00805f9b34fb");
    public static final UUID CCCD = UUID.fromString("713D0000-503E-4C75-BA94-3148F18D941E");
    public static final UUID FIRMWARE_REVISON_UUID = UUID.fromString("00002a26-0000-1000-8000-00805f9b34fb");
    public static final UUID DIS_UUID = UUID.fromString("0000180a-0000-1000-8000-00805f9b34fb");
    public static final UUID RX_SERVICE_UUID = UUID.fromString("713D0001-503E-4C75-BA94-3148F18D941E");
    ...
    private final static UUID CCCD_nRF  = UUID.fromString("00002902-0000-1000-8000-00805f9b34fb");
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
                                         ...
                                         int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                Log.w("lol", "onCharacteristicRead");
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
                                            BluetoothGattCharacteristic characteristic) {
            Log.w("lol", "onCharacteristicChanged");
            broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic);
        }
    };
    ...
    private void broadcastUpdate(final String action,
        ...
        Log.i("jeje","entre al broadcast");
        if (action.equals(ACTION_DATA_AVAILABLE)) {                                      //See if we need to send data
            Log.i("jeje","parece que va llegar un dato");
            if (RX_CHAR_UUID.equals(characteristic.getUuid())) { //See if this is the correct characteristic
                Log.i("jeje","omg llego un dato");
    ...
    public boolean connect(final String address) {
        ...
        Log.w("lol", "mBluetoothGattxd = " + mBluetoothGatt );
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic, boolean enabled) {
        ...
        BluetoothGattDescriptor descriptor = characteristic.getDescriptor(CCCD_nRF); //Get the descripter that enables notification on the server
        if(descriptor==null){
            Log.i("lol","no hay descriptor");
        }else {
            Log.i("lol", "si hay descriptor");
        }
    ...
    public void setCharacteristicIndication(BluetoothGattCharacteristic characteristic, boolean enabled) {
        ...
        BluetoothGattDescriptor descriptor = characteristic.getDescriptor(CCCD_nRF); //Get the descripter that enables indication on the server
...
// ----------------------------------------------------------------------------------------------------------------
    ...
    public void writeCharacteristic(BluetoothGattCharacteristic characteristic) {
        ...
        mBluetoothGatt.writeCharacteristic(characteristic);                      //Request the BluetoothGatt to do the Write
